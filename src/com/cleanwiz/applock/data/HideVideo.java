...
/**
 * Entity mapped to table HideVideo.
 */
public class HideVideo {
    ...
    public HideVideo(Long id) {
        this.id = id;
    }

    public HideVideo(Long id, Integer beyondGroupId, String title, String album, String artist, String oldPathUrl, String displayName, String mimeType, Long duration, String newPathUrl, Long size, Long moveDate) {
        this.id = id;

...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        groupImageDaoConfig = daoConfigMap.get(GroupImageDao.class).clone();
        groupImageDaoConfig.initIdentityScope(type);

        groupImageDao = new GroupImageDao(groupImageDaoConfig, this);

        registerDao(GroupImage.class, groupImageDao);
    }
    
    public void clear() {
        groupImageDaoConfig.getIdentityScope().clear();
    }

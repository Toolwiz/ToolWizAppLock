 ...
 ******************************************************************************/
package com.cleanwiz.applock.data.HideVideoDao;
...
/** 
 * DAO for table HideVideo.
*/
public class HideVideoDao extends AbstractDao<HideVideo, Long> {

    public static final String TABLENAME = "HideVideo";

    /**
     * Properties of entity HideVideo.<br/>
    ...
    */
    ...
    public HideVideoDao(DaoConfig config) {
        super(config);
    }
    
    public HideVideoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'HideVideo' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'HideVideo'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, HideVideo entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public HideVideo readEntity(Cursor cursor, int offset) {
        HideVideo entity = new HideVideo( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, HideVideo entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(HideVideo entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(HideVideo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
